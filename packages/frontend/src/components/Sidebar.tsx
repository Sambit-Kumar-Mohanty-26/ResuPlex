  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mt-auto relative flex justify-center">
          <button
            onClick={() => setIsUserMenuOpen(!isUserMenuOpen)}
            className="h-12 w-12 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center font-bold text-white text-lg cursor-pointer"
          >
          ...
          {isUserMenuOpen && (
            <motion.div
              ...
              className="absolute left-full bottom-0 ml-4 p-4 w-48 bg-gray-800/80 backdrop-blur-md rounded-lg shadow-lg origin-bottom-left"
            >
